...
sd="$db_dir/fc6_00_one_16th.ftr"
q1="$qr_dir/fc6_q_00_04.ftr"
a1="$qr_dir/fc6_q_00_04_one_16th.csv"

if [ $# == 5 ] ; then
sk="SK/pivot_AIR"$1"_w"$2"_s"$3"_k"${tk}"_seq.sk"
else
sk="SK/pivot_AIR"$1"_w"$2"_s"$3"_no_trunc_K_seq.sk"
fi
